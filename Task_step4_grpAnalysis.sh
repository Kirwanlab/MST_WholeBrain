...
compList=(mst)	            								# matches decon prefixes, and will be prefix of output files
compLen=${#compList[@]}

## Hits vs CRs
# arrA=(4)    												# setA beh sub-brik for compList. Must be same length as compList
# arrB=(1)    												# setB
# #arrC=(39 59 65)
# listX=AB													# list of arr? used, for building permutations (e.g. listX=ABC)
# 
# namA=(Hit)										# names of behaviors from arrA. Must be same length as arrA
# namB=(CR)
# #namC=(RpCR CR MpH)

## LureFA vs LureCR
arrA=(7)    												# setA beh sub-brik for compList. Must be same length as compList
arrB=(10)    												# setB
listX=AB													# list of arr? used, for building permutations (e.g. listX=ABC)

namA=(LureFA)										# names of behaviors from arrA. Must be same length as arrA
namB=(LureCR)
